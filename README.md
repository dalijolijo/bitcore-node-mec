...
```bash
git clone https://github.com/dalijolijo/bitcore-node-mec.git
cd bitcore-node-mec
npm install
bitcore-node start
```
...
- [Insight API](https://github.com/dalijolijo/insight-api-mec)
- [Insight UI](https://github.com/dalijolijo/insight-ui-mec)
